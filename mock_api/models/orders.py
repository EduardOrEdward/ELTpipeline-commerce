...
class Order(BaseModel):
    order_id:str=Field(...,ge=1,description="The ID of the order")
    ...
    planned_quantity:int=Field(...,ge=1,description="The amount we planned to get after delivery")
    order_date:date=Field(...,description="The date of our order")
    expected_delivery_date:date=Field(...,description="The date we except our order to be delivered")
